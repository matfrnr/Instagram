...
function UserSuggestions() {
  ...
  }, [spotlightUsers, setSuggestionsLoading]);
    ...
    <div className="mt-6 hidden max-w-[320px] flex-grow lg:block">
      ...
      <div className="pt-5">
        <div className="flex items-center justify-between pb-2">
          <p className="text-sm font-semibold text-[#818181]">À découvrir</p>
          <Link href="/Explore">
            <a>
            ...
            spotlightUserDetails && (
              ...
              >
                <div className="flex items-center gap-2">
                  {spotlightUserDetails.avatarURL && spotlightUserDetails.avatarURL.length !== 0 ? (
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#818181]">
                      Suivi par {spotlightUserDetails.followers!.length}{' '}
