...
function EmojiSelector({ inputText, setInputText }: Props) {
  ...
  return (
    ...
    >
      <h1 className="mt-2 mb-1 font-semibold">Les plus populaires</h1>
      ...
      <h1 className="mt-2 mb-1 font-semibold">Émotions et personnes</h1>
      <div className="flex flex-wrap justify-between ">
      ...
      <h1 className="mt-2 mb-1 font-semibold">Animaux et nature</h1>
      <div className="flex flex-wrap justify-between ">
      ...
      <h1 className="mt-2 mb-1 font-semibold">Voyages et lieux</h1>
      <div className="flex flex-wrap justify-between ">
